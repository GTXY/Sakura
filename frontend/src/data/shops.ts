...
export const shops: Shop[] = [
  {
    ...
    myRating: 4.8,
    oneLiner: '独自一人的隔断座位，一碗纯粹的博多豚骨，世界安静了。',
  ...
  },
  {
    ...
    myRating: 4.5,
    oneLiner: '表参道小巷里的金色招牌，一杯手冲让清晨慢下来。',
  ...
  },
  {
    ...
    myRating: 4.9,
    oneLiner: '西京味噌腌制的银鳕鱼，入口即化，京都的冬天因此有了温度。',
    ...
    featured: true,
    lat: 35.0042, lng: 135.7592,
    phone: '075-221-0003',
    hours: '11:30–14:00 / 17:00–21:00（週一休）',
  },
  {
    id: '004',
    name: '道顿堀今井',
    ...
    myRating: 4.6,
    oneLiner: '大阪最老牌的乌冬，汤底清澈见底，却鲜得让人无言。',
    ...
    featured: false,
    lat: 34.6685, lng: 135.5020,
    phone: '06-6211-0319',
    hours: '11:00–21:30（週三休）',
  },
  {
    id: '005',
    name: '中洲屋台',
  ...
  },
  {
    ...
    myRating: 4.3,
    oneLiner: '昭和气息扑面而来，烤鸡串的烟雾与霓虹灯混在一起，穿越感十足。',
    ...
    featured: false,
    lat: 35.6939, lng: 139.7004,
    hours: '各攤位不同，約 17:00–24:00',
  },
  {
    id: '007',
    name: '筑地场外 寿司大',
    ...
    myRating: 5.0,
    oneLiner: '清晨五点排队，握寿司一个接一个，每口都是海洋的心意。',
  ...
  },
  {
    ...
    myRating: 4.5,
    oneLiner: '大阪的厨房，市场里站着吃的海鲜定食，新鲜、粗犷、满足。',
    description: '大阪的厨房——黑门市场的活力让人振奋，松叶的定食不讲究摆盘，只讲究食材本身的说话权。刚切的生鱼片、现烤的贝壳，配上一碗白米饭，粗粝却真实。',
    coverImage: 'https://images.unsplash.com/photo-1510130387-6f748462204a?w=800&q=80',
    photos: [
      'https://images.unsplash.com/photo-1510130387-6f748462204a?w=800&q=80',
      'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=800&q=80',
    ],
    featured: false,
    lat: 34.6708, lng: 135.5063,
  ...
  },
  {
    ...
    myRating: 4.7,
    oneLiner: '镰仓老街的刨冰，草莓炼乳堆得像雪山，夏日的高配答案。',
    ...
    featured: true,
    lat: 35.3197, lng: 139.5502,
    phone: '0467-61-3543',
    hours: '10:00–17:30（週四休）',
  },
]

export const featuredShops = shops.filter((s) => s.featured)

export const stats = {
  total: shops.length,
  prefectures: [...new Set(shops.map((s) => s.prefecture))].length,
}
